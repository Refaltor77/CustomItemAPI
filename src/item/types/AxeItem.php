...
class AxeItem extends Axe implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier, string $name, int $durability, float $efficiency, string $textureName, int $attack, int $renderOffset, ToolTier $tier)
    {
        ...
        $inventory = new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT, CreativeInventoryInfo::GROUP_AXE);
